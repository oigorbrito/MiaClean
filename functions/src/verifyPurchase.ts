...
/**
 * The /verifyPurchase endpoint enforces a hard limit of 10 purchase items per request to
 * mitigate Denial-of-Service (DoS) and Google Play Developer API quota exhaustion.
 */
