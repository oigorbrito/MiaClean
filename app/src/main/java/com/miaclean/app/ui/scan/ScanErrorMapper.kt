...
import androidx.annotation.StringRes; import com.miaclean.app.R; import com.miaclean.app.domain.ScanErrorCode
object ScanErrorMapper {
    @StringRes
    fun mapToFriendlyMessage(errorCode: ScanErrorCode): Int = when (errorCode) {
