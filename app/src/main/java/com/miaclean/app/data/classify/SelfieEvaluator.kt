 ...
 *  2. Any of `lensModel`, `make`, `model`, `imageDescription` contains a front-camera token. This
 *     covers OEMs that annotate the capturing lens (Samsung's "Front Camera", Xiaomi, etc.).
