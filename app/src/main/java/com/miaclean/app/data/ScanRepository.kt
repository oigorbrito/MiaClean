...
class ScanRepository @Inject constructor(
    ...
    fun scan(additionalSafTreeUris: List<Uri> = emptyList()): Flow<ScanProgress> = channelFlow {
        try {
            ...
            send(ScanProgress.Failed(com.miaclean.app.R.string.scan_error_permission_revoked))
        } catch (e: java.io.FileNotFoundException) {
            send(ScanProgress.Failed(com.miaclean.app.R.string.scan_error_media_unavailable))
        } catch (e: Exception) {
            send(ScanProgress.Failed(com.miaclean.app.R.string.scan_error_unexpected))
        }
    }
